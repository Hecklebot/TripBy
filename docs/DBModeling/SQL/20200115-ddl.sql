...
CREATE TABLE `trip_notes_pic` (
	...
	`trip_day_id` INTEGER     NOT NULL, -- 여행일차번호
	`file_name`   VARCHAR(50) NOT NULL  -- 파일이름
);
...
CREATE TABLE `member_reports` (
	`repo_id`   INTEGER NOT NULL, -- 신고자번호
	`repoed_id` INTEGER NOT NULL, -- 피신고자번호
...
ALTER TABLE `trip_day`
	MODIFY COLUMN `trip_day_id` INTEGER NOT NULL AUTO_INCREMENT;
